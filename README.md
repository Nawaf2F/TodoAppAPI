...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0c6e03a5-7870-4854-b6b2-42a628a02276
```

> `0c6e03a5-7870-4854-b6b2-42a628a02276` is the password of the certificate, you can change it to any password you want.
